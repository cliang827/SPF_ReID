function [OF, ave_conf] = GetOF2(feedback,num,iProbe,include_groundtruth_in_the_first_page_flag)
...
%     [~, RST(1,:)] = sort(ST,'descend');
%     [~, RDT(1,:)] = sort(DT,'descend');
%     [~, RSL(1,:)] = sort(SL,'descend');
%     [~, RDL(1,:)] = sort(DL,'descend');
