function [alpha_list, beta_list, gamma_list] = init_SPF_parameters_normalized_mver(W, Y, f, V, FBL, query_times, ctrl_para)

% save('.\temp\init_SPF_parameter.mat', 'W', 'Y', 'f', 'V', 'FBL', 'query_times', 'ctrl_para');

% clear all
% clc
% load('.\temp\init_SPF_parameter.mat');
