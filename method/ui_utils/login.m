...
% Last Modified by GUIDE v2.5 14-Nov-2017 19:48:05
...
% so window can get raised using login.
...
% cla;
% 
% popup_sel_index = get(handles.popupmenu_operator, 'Value');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
selection = questdlg(['Close ' get(handles.login,'Name') '?'],...
                     ['Close ' get(handles.login,'Name') '...'],...
                     'Yes','No','Yes');
if strcmp(selection,'No')
    return;
end

delete(handles.login)
...
set(hObject, 'String', {'default', 'Long-Xiang Jiang', 'Liang Hu', 'Su Yan', 'Chao Liang'});
...
set(hObject, 'String', {'viper', 'cuhk02'});
...
list_user_handle = findobj(handles.login, 'Tag', 'popupmenu_operator');
list_user_contents = get(list_user_handle, 'String');
operator = list_user_contents{get(list_user_handle, 'Value')};
setappdata(0, 'operator', operator);



list_dataset_handle = findobj(handles.login, 'Tag', 'popupmenu_dataset');
list_dataset_contents = get(list_dataset_handle, 'String');
dataset = list_dataset_contents{get(list_dataset_handle, 'Value')};
setappdata(0, 'dataset', dataset);

list_method_handle = findobj(handles.login, 'Tag', 'popupmenu_method');
list_method_contents = get(list_method_handle, 'String');
method = list_method_contents{get(list_method_handle, 'Value')};
