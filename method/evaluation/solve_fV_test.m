function [f, V, para_set, J_val, dist] = solve_fV_test(ctrl_para, probe_id)
...
if DEBUG_FLAG
    ...
    max_para_adjust_times = 4;              % when query_times > max_para_adjust_times, alpha/beta/gamma no longer changed
